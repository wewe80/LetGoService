...
namespace LetGoService.Handlers
{
    public class RequestManager
    {
        ...
        public HttpWebResponse SendPushRequest(string uri)
        {
            string body = "{\"text\":\"hello\",\"complete\":false}";
            HttpWebRequest request = GeneratePushRequest(uri, "Post", "application/json", body);
        ...
        public static HttpWebRequest BuildWebRequest(String URL, String method, string contentType)
        {
            ...
            webRequest.Headers.Add("X-ZUMO-APPLICATION", "fdgORrjVJswgWsONDJRUpICkkuakLS94");

            return webRequest;
        }

        internal HttpWebRequest GeneratePushRequest(string uri, string method, string body, string contentType)
        {
            HttpWebRequest request = BuildWebRequest(uri, method, contentType);
        ...
        private void WriteRequestBody(HttpWebRequest webRequest, String body)
        {
